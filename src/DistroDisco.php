...
class DistroDisco
{
    ...
    const NAME = 'DistroDisco';

    const VERSION = '1.0.0';

    /**
     * DistroDisco constructor.
     * @param Config               $config
    ...
    public function __construct(Config $config, InputInterface $input = null, OutputInterface $output = null)
    {
        ...
        $commandClasses = $discovery->discover(__DIR__ . '/Commands', '\DistroDisco\Commands');
    ...
    public function run(InputInterface $input, OutputInterface $output)
    {
        ...
        $lock = $factory->createLock('distro-disco-command');
